<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Home.aspx.vb" Inherits="EComm.Home" %>
<!DOCTYPE html>
...
<head>
    ...
    <style>
       ...
       .search-form input[type="search"] {
        ...
        /* Jumbotron */
       .jumbotron {
            background-image: url('https://dslv9ilpbe7p1.cloudfront.net/V13cGssW7xXMQIr2eAidtA_store_banner_image.jpeg');
       ...
       .showcase-item {
            text-align: center;
            margin-bottom: 50px; /* Add space between showcase items */
        }
       .showcase-item img {
...
<body>
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <p class="lead">This is a site for anime lovers</p>
        </div>
    </div>
